...
class ResUtil
{
    ...
    */
    public static createMovieClip(fileName: string, mcName: string): egret.MovieClip
    {
    ...
    * 创建一个位图文本框
    */
    public static createBitmapText(fntName: string, content: string = "", anchorX: number = 0, anchorY: number = 0): egret.BitmapText
    {
